...
import { SINGN_USER } from "@/services/mutations/singn";
    ...
    <div className="flex flex-col m-4 m-auto w-sm mt-20">
      ...
      <form onSubmit={handleSingn}>
        ...
        <Button
          type="submit"
          txt="S'inscrire"
          className="w-32 rounded-md hover:bg-redpapilles hover:text-white"
        />
        <Button
          type="button"
          txt={
      ...
      <Link
        href="/login"
        className="text-right mt-4 mb-4 hover:text-redpapilles"
      >
        Déjà un compte ?
      </Link>
    </div>
