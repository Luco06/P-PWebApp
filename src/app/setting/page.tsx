...
const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    ...
    <div className='flex flex-col items-center jutify-center  m-auto w-lg mt-10'>
      ...
      <Input autoComplete="false" className='w-96' label='Pseudo' type='text' value={userUpdate.pseudo} onChange={(e)=> setUserUpdate({...userUpdate, pseudo: e.target.value})} name='pseudo' id='pseudo' required={false}/>
      <Input autoComplete="false" className='w-96'  label='Mot de passe' type='password' value={userUpdate.mdp} onChange={(e)=> setUserUpdate({...userUpdate, mdp: e.target.value})} name='mdp' id='mdp' required={false}/>
